...
<div class="Formfillup">
 <h1 class="text-dark">Reservation is Successfull</h1>
 <br><br>   
 <hr>
 <div class="d-grid gap-2">
 <a href="Maininterface-client.php"><button type="button" name="btnConfirm" class="btn btn-outline-success">Make Another Reservation</button></a>
</div>
</div>
