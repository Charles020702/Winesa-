...
<h2>Signup As:</h2>
<ul>
<button type = "button"><span></span><a style = "color:white" href = "Signup-client.php"><i class="bi bi-people-fill"></i>Client/Customer</button></a>
<button type = "button"><span></span><a style = "color:white" href = "Signup-admin.php"><i class="bi bi-laptop-fill"></i>Admin/Owner</button></a>
</ul>
</div>
